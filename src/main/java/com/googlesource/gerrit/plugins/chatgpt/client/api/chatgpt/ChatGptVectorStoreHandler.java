...
import com.googlesource.gerrit.plugins.chatgpt.client.api.chatgpt.endpoint.ChatGptVectorStore;
import com.googlesource.gerrit.plugins.chatgpt.client.api.chatgpt.endpoint.ChatGptVectorStoreFileBatch;
...
public class ChatGptVectorStoreHandler extends ClientBase {
  ...
  private void createVectorStoreFileBatch(String vectorStoreId, List<String> fileIds)
    ...
    ChatGptResponse createVectorStoreFileBatchResponse =
  ...
  private boolean checkVectorStoreStatus(String vectorStoreId)
    ...
    if (ChatGptPoller.isNotCompleted(vectorStoreFileBatchStatus)) {
      ...
      ChatGptResponse vectorStoreFileBatchResponse =
