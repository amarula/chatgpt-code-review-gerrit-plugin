...
@Slf4j
public class ChatGptPromptStatefulReviewCommitMessage extends ChatGptPromptStatefulReview
  ...
  public ChatGptPromptStatefulReviewCommitMessage(
    ...
    log.debug(
        "Initialized ChatGptPromptStatefulReviewCommitMessage for project: {}",
