...
import static com.googlesource.gerrit.plugins.chatgpt.client.api.gerrit.GerritClientPatchSetHelper.filterCommitMessage;
import static com.googlesource.gerrit.plugins.chatgpt.utils.TextUtils.joinWithNewLine;

@Slf4j
public class ChatGptPromptReviewCommitMessage extends ChatGptPromptReview
    implements IChatGptPrompt {
  ...
  public ChatGptPromptReviewCommitMessage(
      Configuration config,
      ChangeSetData changeSetData,
      GerritChange change,
      ICodeContextPolicy codeContextPolicy) {
    super(config, changeSetData, change, codeContextPolicy);
    loadDefaultPrompts("promptsReviewCommitMessage");
    log.debug(
        "Initialized ChatGptPromptReviewCommitMessage for project: {}",
