...
public class DebugCodeBlocksPromptingParamInstructions extends DebugCodeBlocksPromptingParamBase {
  ...
  protected void populateStatefulSpecializedCodeReviewParameters() {
    promptingParameters.put(
        "AssistantCodeInstructions", chatGptPromptStateful.getDefaultGptAssistantInstructions());
  }
  ...
  protected void populateStatefulSpecializedCommitMessageReviewParameters() {
    promptingParameters.put(
        ...
        chatGptPromptStateful.getDefaultGptAssistantInstructions());
  }

  @Override
  protected void populateStatefulReviewParameters() {
    promptingParameters.put(
        "AssistantInstructions", chatGptPromptStateful.getDefaultGptAssistantInstructions());
  }

  @Override
  protected void populateStatelessParameters() {
    promptingParameters.put(
        "AssistantInstructions", localizer.getText("message.dump.instructions.mode.mismatch"));
  }
}
