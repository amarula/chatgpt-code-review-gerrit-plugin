...
import com.googlesource.gerrit.plugins.chatgpt.model.api.chatgpt.ChatGptCreateVectorStoreRequest;
...
public class ChatGptVectorStoreFileBatch extends ChatGptApiBase {
  ...
  private Request vectorStoreFileBatchCreateRequest(String vectorStoreId, List<String> fileIds) {
    String uri = UriResourceLocator.vectorStoreFileBatchCreateUri(vectorStoreId);
