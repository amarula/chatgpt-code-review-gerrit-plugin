...
public class ChatGptClientStateful extends ChatGptClient implements IChatGptClient {
  ...
  public ChatGptResponseContent ask(
    ...
    log.info(
        "Processing STATEFUL ChatGPT Request with changeId: {}, Patch Set: {}",
  ...
  private ChatGptResponseContent getResponseContentStateful(String threadId)
      throws OpenAiConnectionFailException {
    return switch (chatGptRunHandler.getFirstStepDetails().getType()) {
      ...
      default ->
          throw new IllegalStateException(
              "Unexpected Step Type in Stateful ChatGpt response: " + chatGptRunHandler);
    };
  }
