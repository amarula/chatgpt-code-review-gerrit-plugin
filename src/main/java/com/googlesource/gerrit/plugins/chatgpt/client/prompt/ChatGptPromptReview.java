...
@Slf4j
public class ChatGptPromptReview extends ChatGptPromptBase
  ...
  public ChatGptPromptReview(
    ...
    loadDefaultPrompts("promptsReview");
    log.debug(
        "ChatGptPromptReview initialized for change ID: {}", change.getFullChangeId());
  }
