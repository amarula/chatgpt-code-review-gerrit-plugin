...
public class Configuration extends ConfigCore {
    ...
    private static final String DEFAULT_GIT_CODEBASE_UPLOAD_POLICY = "ALL";
    ...
    private static final String KEY_GIT_CODEBASE_UPLOAD_POLICY = "gitCodebaseUploadPolicy";
    ...
    public UploadPolicies getGitCodebaseUploadPolicy() {
        return getEnum(KEY_GIT_CODEBASE_UPLOAD_POLICY, DEFAULT_GIT_CODEBASE_UPLOAD_POLICY, UploadPolicies.class);
    }
