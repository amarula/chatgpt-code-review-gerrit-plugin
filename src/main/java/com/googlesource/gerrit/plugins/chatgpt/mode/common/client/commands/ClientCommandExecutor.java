...
import com.googlesource.gerrit.plugins.chatgpt.config.DirectivesDynamicConfigManager;
...
public class ClientCommandExecutor extends ClientCommandBase {
    ...
    private void commandDynamicallyConfigure() {
        ...
        dynamicConfigManager.updateConfiguration(shouldResetDynamicConfig, modifiedDynamicConfig);
    }
