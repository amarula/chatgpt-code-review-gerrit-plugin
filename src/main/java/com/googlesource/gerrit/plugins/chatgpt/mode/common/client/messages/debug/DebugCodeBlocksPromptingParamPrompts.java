...
public class DebugCodeBlocksPromptingParamPrompts extends DebugCodeBlocksPromptingParamBase {
  ...
  protected void populateStatefulSpecializedCodeReviewParameters() {
    promptingParameters.put(
        "ReviewCodePrompt",
        chatGptPromptStateful.getDefaultGptThreadReviewMessage(PATCH_SET_PLACEHOLDER));
  }
  ...
  protected void populateStatefulSpecializedCommitMessageReviewParameters() {
    promptingParameters.put(
        ...
        chatGptPromptStateful.getDefaultGptThreadReviewMessage(COMMIT_MESSAGE_PATCH_TEMPLATE));
  }
  ...
  protected void populateStatelessParameters() {
    ...
    promptingParameters.put(
        "UserPrompt",
        chatGptPromptStateless.getGptUserPrompt(changeSetData, COMMIT_MESSAGE_PATCH_TEMPLATE));
  }
}
