...
@Slf4j
public abstract class ChatGptPromptBase extends ChatGptPrompt
  ...
  public ChatGptPromptBase(
    ...
    loadDefaultPrompts("promptsMemory");
    log.debug("Initialized ChatGptPromptBase with change ID: {}", change.getFullChangeId());
  }
