...
public class ChatGptClientStateless extends ChatGptClient implements IChatGptClient {
  ...
  private ChatGptCompletionRequest createRequestBody(
      Configuration config, ChangeSetData changeSetData, String patchSet) {
    ChatGptPromptStateless chatGptPromptStateless =
        new ChatGptPromptStateless(config, isCommentEvent);
    ChatGptRequestMessage systemMessage =
        ChatGptRequestMessage.builder()
            .role("system")
            .content(chatGptPromptStateless.getGptSystemPrompt())
            .build();
    ChatGptRequestMessage userMessage =
        ChatGptRequestMessage.builder()
            .role("user")
    ...
    ChatGptTool[] tools = new ChatGptTool[] {chatGptTools.retrieveFunctionTool()};
