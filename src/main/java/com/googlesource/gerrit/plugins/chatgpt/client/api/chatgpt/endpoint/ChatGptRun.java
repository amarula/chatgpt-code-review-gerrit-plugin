...
import com.googlesource.gerrit.plugins.chatgpt.client.api.chatgpt.ChatGptPoller;
...
public class ChatGptRun extends ChatGptApiBase {
  ...
  public Request getStepsRequest(String runId) {
    String uri = UriResourceLocator.runStepsUri(threadId, runId);
  ...
  private Request createRunRequest() {
    String uri = UriResourceLocator.runsUri(threadId);
  ...
  private Request getCancelRequest(String runId) {
    String uri = UriResourceLocator.runCancelUri(threadId, runId);
  ...
  private Request submitToolOutputsRequest(List<ChatGptToolOutput> toolOutputs) {
    String uri = UriResourceLocator.runSubmitToolOutputsUri(threadId, runId);
