...
@Slf4j
public class ChatGptPromptStatefulRequests extends ChatGptPromptStatefulBase
  ...
  public ChatGptPromptStatefulRequests(
    ...
    log.debug(
        "ChatGptPromptStatefulRequests initialized for change ID: {}", change.getFullChangeId());
  }
  ...
  private String getCommentRequestPrompt(int commentPropertiesSize) {
    log.debug(
        "Constructing Stateful comment request prompt for {} comment properties.",
