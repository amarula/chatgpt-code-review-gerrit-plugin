...
import static com.googlesource.gerrit.plugins.chatgpt.client.api.gerrit.GerritClientPatchSetHelper.filterPatchWithoutCommitMessage;

@Slf4j
public class ChatGptPromptReviewCode extends ChatGptPromptReview
    implements IChatGptPrompt {

  public ChatGptPromptReviewCode(
    ...
    log.debug(
        "ChatGptPromptReviewCode initialized for project: {}", change.getProjectName());
  }
