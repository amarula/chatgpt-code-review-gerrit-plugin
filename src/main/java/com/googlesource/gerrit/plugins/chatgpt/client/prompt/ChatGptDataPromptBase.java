...
import com.googlesource.gerrit.plugins.chatgpt.client.code.patch.InlineCode;
...
public abstract class ChatGptDataPromptBase implements IChatGptDataPrompt {
  ...
  @Getter protected final List<ChatGptMessageItem> messageItems;
  ...
  protected void setHistory(
      ChatGptMessageItem messageItem, List<ChatGptRequestMessage> messageHistory) {
