...
@Slf4j
public class ChatGptPromptReviewReiterated extends ChatGptPromptReview
    implements IChatGptPrompt {

  public ChatGptPromptReviewReiterated(
    ...
    log.debug(
        "ChatGptPromptReviewReiterated initialized for project: {}",
