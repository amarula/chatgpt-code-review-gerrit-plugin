...
import com.googlesource.gerrit.plugins.reviewai.backendai.common.client.commands.ClientCommandParser;
...
public class ClientMessageParser extends ClientMessageBase {
  ...
  public boolean isBotAddressed(String message) {
    ...
    if (!userMatcher.find()) {
      log.debug(
          "Skipping action since the comment does not mention the OpenAI bot."
