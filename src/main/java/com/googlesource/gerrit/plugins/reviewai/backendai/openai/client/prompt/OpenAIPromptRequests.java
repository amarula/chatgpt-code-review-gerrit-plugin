...
@Slf4j
public class OpenAIPromptRequests extends OpenAIPromptBase implements IOpenAIPrompt {
  public static String DEFAULT_GPT_ASSISTANT_INSTRUCTIONS_REQUESTS;

  public OpenAIPromptRequests(
    ...
    log.debug("OpenAIPromptRequests initialized for change ID: {}", change.getFullChangeId());
  }
