...
import static com.googlesource.gerrit.plugins.reviewai.backendai.common.client.prompt.AIPrompt.getJsonPromptValues;
import static com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.code.context.CodeContextPolicyBase.CodeContextPolicies;
import static com.googlesource.gerrit.plugins.reviewai.settings.Settings.BackendsAI;
...
public class Configuration extends ConfigCore {
  ...
  private static final String DEFAULT_BACKEND_AI = "OPENAI";
  ...
  private static final boolean DEFAULT_IGNORE_RESOLVED_OPENAI_COMMENTS = true;
  ...
  private static final String KEY_BACKEND_AI = "backendAI";
  ...
  private static final String KEY_IGNORE_RESOLVED_OPENAI_COMMENTS = "ignoreResolvedOpenAIComments";
  ...
  public BackendsAI getBackendAI() {
    return getEnum(KEY_BACKEND_AI, DEFAULT_BACKEND_AI, BackendsAI.class);
  }
  ...
  public boolean getIgnoreResolvedOpenAIComments() {
    return getBoolean(KEY_IGNORE_RESOLVED_OPENAI_COMMENTS, DEFAULT_IGNORE_RESOLVED_OPENAI_COMMENTS);
  }
