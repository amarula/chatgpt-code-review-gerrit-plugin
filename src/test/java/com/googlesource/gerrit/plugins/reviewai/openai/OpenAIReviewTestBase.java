...
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.model.api.openai.OpenAIListResponse;
...
import static com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.api.openai.OpenAIPoller.COMPLETED_STATUS;
...
public class OpenAIReviewTestBase extends ReviewTestBase {
  ...
  protected void setupMockRequests() throws RestApiException {
    ...
    String repoJson = readTestFile("__files/openai/gitProjectFiles.json");
    ...
    formattedPatchContent = readTestFile("__files/openai/gerritFormattedPatch.txt");
    ...
    DiffInfo testFileDiff =
        readTestFileToClass("__files/openai/gerritPatchSetDiffTestFile.json", DiffInfo.class);
  ...
  protected void initComparisonContent() {
    ...
    promptTagComments = readTestFile("__files/openai/openAIPromptTagRequests.json");
  }
