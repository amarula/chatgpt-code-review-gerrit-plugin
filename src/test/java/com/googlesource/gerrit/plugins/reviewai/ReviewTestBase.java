...
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.api.openai.OpenAIClientTaskSpecific;
...
import com.googlesource.gerrit.plugins.reviewai.interfaces.backendai.common.client.api.gerrit.IGerritClientPatchSet;
...
import com.googlesource.gerrit.plugins.reviewai.backendai.common.client.api.gerrit.GerritClientComments;
import com.googlesource.gerrit.plugins.reviewai.backendai.common.client.api.gerrit.GerritClientFacade;
...
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.api.openai.OpenAIClient;
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.api.gerrit.GerritClientPatchSetOpenAI;
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.api.git.GitRepoFiles;
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.code.context.CodeContextPolicyNone;
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.code.context.CodeContextPolicyOnDemand;
import com.googlesource.gerrit.plugins.reviewai.backendai.openai.client.code.context.CodeContextPolicyUploadAll;
...
public class ReviewTestBase extends TestBase {
  ...
  private IAIClient getOpenAIClient() {
    return switch (config.getBackendAI()) {
      case OPENAI ->
