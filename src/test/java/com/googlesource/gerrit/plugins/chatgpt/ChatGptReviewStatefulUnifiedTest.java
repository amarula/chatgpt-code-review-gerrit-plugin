...
public class ChatGptReviewStatefulUnifiedTest extends ChatGptReviewStatefulTestBase {
  ...
  private void setupVectorStoreFailure() {
    ...
    WireMock.stubFor(
        WireMock.post(
                WireMock.urlEqualTo(
                    UriResourceLocatorStateful.vectorStoreFileBatchCreateUri(
  ...
  public void patchSetCreatedOrUpdated() throws Exception {
    ...
    String reviewMessageCommitMessage =
        getReviewMessage("__files/stateful/chatGptRunStepsResponse.json", 1);
  ...
  public void filesCreateResponse400() {
    WireMock.stubFor(
        WireMock.post(WireMock.urlEqualTo(UriResourceLocatorStateful.filesCreateUri()))
            .willReturn(
                WireMock.aResponse()
  ...
  public void vectorStoreCreateFailure() {
    ...
    WireMock.stubFor(
        WireMock.post(
                WireMock.urlEqualTo(
                    UriResourceLocatorStateful.vectorStoreFileBatchRetrieveUri(
  ...
  public void threadCreateResponse400() {
    WireMock.stubFor(
        WireMock.post(WireMock.urlEqualTo(UriResourceLocatorStateful.threadsUri()))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(HTTP_BAD_REQUEST)
                    .withHeader(
  ...
  public void runCreateResponse400() {
    WireMock.stubFor(
        WireMock.post(WireMock.urlEqualTo(UriResourceLocatorStateful.runsUri(CHAT_GPT_THREAD_ID)))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(HTTP_BAD_REQUEST)
                    .withHeader(
  ...
  public void runStepsInitialEmptyResponse() throws Exception {
    ...
    try (MockedStatic<ThreadUtils> mocked = Mockito.mockStatic(ThreadUtils.class)) {
      ...
      String reviewMessageCode =
          getReviewMessage("__files/stateful/chatGptRunStepsResponse.json", 0);
      String reviewMessageCommitMessage =
          getReviewMessage("__files/stateful/chatGptRunStepsResponse.json", 1);
  ...
  public void runStepsResponse400() {
    WireMock.stubFor(
        WireMock.get(
                WireMock.urlEqualTo(
                    UriResourceLocatorStateful.runStepsUri(CHAT_GPT_THREAD_ID, CHAT_GPT_RUN_ID)))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(HTTP_BAD_REQUEST)
                    .withHeader(
  ...
  public void patchSetCreatedReiterateRequestForTextualResponse() throws Exception {
    String reviewReiteratePrompt =
        new ChatGptPromptStatefulReviewReiterated(
  ...
  public void gptMentionedInComment() throws RestApiException {
    String reviewMessageCommitMessage =
        getReviewMessage("__files/stateful/chatGptResponseRequestStateful.json", 0);
