...
public class ChatGptReviewStatefulTestBase extends ChatGptReviewTestBase {
  ...
  protected void setupMockRequests() throws RestApiException {
    ...
    WireMock.stubFor(
        WireMock.post(WireMock.urlEqualTo(UriResourceLocatorStateful.vectorStoreCreateUri()))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(HTTP_OK)
                    .withHeader(HttpHeaders.CONTENT_TYPE, ContentType.APPLICATION_JSON.toString())
    ...
    WireMock.stubFor(
        WireMock.post(
                WireMock.urlEqualTo(
                    UriResourceLocatorStateful.threadMessagesUri(CHAT_GPT_THREAD_ID)))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(HTTP_OK)
                    .withHeader(HttpHeaders.CONTENT_TYPE, ContentType.APPLICATION_JSON.toString())
  ...
  protected void setupMockRequestCreateAssistant(
    ...
    WireMock.stubFor(
        getScenarioMapping(
                UriResourceLocatorStateful.assistantCreateUri(),
                "Assistant Scenario",
                fromState,
                toState)
            .willReturn(
  ...
  protected void setupMockRequestCreateRun(
    ...
    WireMock.stubFor(
        getScenarioMapping(
                UriResourceLocatorStateful.runsUri(CHAT_GPT_THREAD_ID),
                "Create-Run Scenario",
                fromState,
                toState)
  ...
  protected void setupMockRequestRetrieveRunStepsFromBody(String body, String runId) {
    ...
    WireMock.stubFor(
        WireMock.get(
                WireMock.urlEqualTo(
                    UriResourceLocatorStateful.runStepsUri(CHAT_GPT_THREAD_ID, runId)))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(HTTP_OK)
                    .withHeader(HttpHeaders.CONTENT_TYPE, ContentType.APPLICATION_JSON.toString())
  ...
  protected void setupMockRequestRetrieveRunSteps(String bodyFile, String runId) {
    setupMockRequestRetrieveRunStepsFromBody(
        readTestFile(RESOURCE_STATEFUL_PATH + bodyFile), runId);
  }
