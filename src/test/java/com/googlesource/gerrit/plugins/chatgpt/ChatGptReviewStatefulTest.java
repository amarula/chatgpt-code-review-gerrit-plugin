...
public class ChatGptReviewStatefulTest extends ChatGptReviewTestBase {
    ...
    private String patchSetContent;
    ...
    protected void setupMockRequests() throws RestApiException {
        ...
        String patchContent = readTestFile("__files/gerritPatchSet.txt");
        ByteArrayInputStream inputStream = new ByteArrayInputStream(patchContent.getBytes());
        BinaryResult binaryResult = BinaryResult.create(inputStream)
                .setContentType("text/plain")
                .setContentLength(patchContent.length());
    ...
    protected void initComparisonContent() {
        ...
        patchSetContent = readTestFile("__files/gerritPatchSet.txt");
    ...
    public void patchSetCreatedOrUpdated() throws Exception {
        String reviewUserPrompt = chatGptPromptStateful.getDefaultGptThreadReviewMessage(patchSetContent);
