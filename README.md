...
- `gptUploadedChunkSizeMb`: When uploading project repositories to ChatGPT, the repositories are packaged and split into
...
For example, all DEBUG messages in classes whose log messages start with the ChatGPT request and response bodies can be
elevated with:
